...
// Code tab switcher
export function switchTab(element, tabKey) {
...
// Countdown timer
export function startCountdown(durationMinutes) {
...
export function openCheckout(packageName, price) {
...
export function toggleOrderBump(checkbox) {
...
// Attach global listeners for inline onclick attributes
if (typeof window !== 'undefined') {
  window.switchTab = switchTab;
  window.scrollToPricing = scrollToPricing;
  window.openCheckout = openCheckout;
  window.closeCheckout = closeCheckout;
  window.toggleOrderBump = toggleOrderBump;
  window.goToStep = goToStep;
  window.handleCheckoutSubmit = handleCheckoutSubmit;
  window.acceptUpsell = acceptUpsell;
  window.finishFunnel = finishFunnel;
